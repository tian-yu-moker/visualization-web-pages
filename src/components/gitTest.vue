...
export default {
  ...
  methods:{
    loadGeoMapData()
    {
      ...
      axios.get('../../static/JsonData/England.json', {}).then(response =>
      {
        if (response.status == 200)
        {
          ...
          let urlMap = "http://8.218.186.230:8090/mapData";
    ...
    drawDefaultCalendarTY()
    {
      ...
      let urlAll = "http://8.218.186.230:8090/calendarData";
    ...
    TotalLineHeaderOptionXK() {
      ...
      let urlAll = "http://8.218.186.230:8090/Acc/getDailyAcc";
      axios.get(urlAll).then(response =>
      {
        //If query is success
        if (response.status == 200)
    ...
    GSWdrawGDPandPopulation() {
      ...
      let GSWThirdOption;
      let GSWThirdUrl="http://8.218.186.230:8090/gdpAccident"
    ...
    drawVehicleBrandsTreemapTY() {
      ...
      // this.overview.setOption(this.curBrandOption);
      let urlAll = "http://8.218.186.230:8090/cars/getAllCars";
      axios.get(urlAll).then(response =>
      {
        // If query is success
        if (response.status == 200)
...
// prettier-ignore
      let GSWintvalue=[];
      let GSWFirstUrl="http://8.218.186.230:8090/dayandtime";
    ...
    {
      let url = "http://8.218.186.230:8090/vehicle/types";
